...
date: "2024-05-17"
desc: "git merge의 두 가지 전략, git pull 옵션에 대해 알아보자"
---
...
![fast-forward.png](public/posts/git/merge_rebase_pull/fast-forward.png)
...
![not_fast-forward.png](public/posts/git/merge_rebase_pull/not_fast-forward.png)

![fast-forward3.png](public/posts/git/merge_rebase_pull/3-way_merge.png)

# git rebase란?

현재 브랜치의 커밋을 다른 브랜치의 가장 최신 커밋 위로 이동시키는 명령어이다. base가 다른 브랜치의 가장 최신 커밋이 된다.

![rebase.png](public/posts/git/merge_rebase_pull/rebase.png)
